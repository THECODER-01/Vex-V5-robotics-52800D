...
def ondriver_drivercontrol_0():
    ...
    while True:
        # \/ Read controller axes each loop so values update continuously (You can also use other axes for arcade or split arcade control(currently it is tank drive)) \/
